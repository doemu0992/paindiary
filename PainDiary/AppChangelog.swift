...
let appChangelog: [WhatsNewVersion] = [
    WhatsNewVersion(version: "2.0", build: "33", aenderungen: [
        ...
        WhatsNewAenderung(icon: "thermometer.medium", farbe: .orange,
                          titel: "Basaltemperatur bestätigt den Eisprung",
                          beschreibung: "Die Temperaturkurve wird jetzt nach der symptothermalen 3-über-6-Regel ausgewertet: Ein anhaltender Anstieg um 0,2 °C bestätigt den Eisprung rückwirkend – auch ohne Ovulationstest. Priorität der Signale: LH-Test, Temperaturanstieg, Zervixschleim, Kalender. Wirkt auch auf bereits erfasste Daten."),
        WhatsNewAenderung(icon: "calendar.badge.clock", farbe: .pink,
                          titel: "Periodenvorhersage folgt dem Eisprung",
                          beschreibung: "Verschiebt sich der Eisprung (negative Tests, später Schleim-Peak), verschiebt sich jetzt auch die vorhergesagte Periode – denn die Lutealphase ist konstant. Die App lernt deine persönliche Lutealphasen-Länge aus den eigenen Zyklen."),
        WhatsNewAenderung(icon: "checkmark.shield.fill", farbe: .pink,
                          titel: "Zyklusberechnung robuster",
                          beschreibung: "Vergessene Erfassungstage zerreissen die Periode nicht mehr, Zwischenblutungen zählen nicht als neuer Zyklus, und Tracking-Pausen verfälschen die Statistik nicht mehr – nur plausible Zykluslängen (21–60 Tage) fliessen in die Vorhersage ein."),
        WhatsNewAenderung(icon: "moon.zzz.fill", farbe: .teal,
                          titel: "Temperatur-Störfilter über Modulgrenzen",
                          beschreibung: "Basaltemperatur-Werte an Tagen mit Alkohol am Vorabend oder zu kurzem Schlaf werden automatisch aus der Eisprung-Erkennung ausgeschlossen – möglich nur, weil PainDiary diese Daten aus Wellness- und Schlaf-Tracking kennt."),
        WhatsNewAenderung(icon: "bolt.heart.fill", farbe: .pink,
                          titel: "Mittelschmerz & Ovulationsblutung als Signale",
                          beschreibung: "Krämpfe mitten im Zyklus (Mittelschmerz) und isolierte Schmierblutungen um den Eisprung fliessen jetzt als Signale in die Vorhersage ein. Cremiger Zervixschleim öffnet das fruchtbare Fenster. Das Lernen gewichtet nach Signalqualität: LH-Test dreifach, Temperatur doppelt."),
        WhatsNewAenderung(icon: "scope", farbe: .orange,
                          titel: "Ehrliche Vorhersagen mit Bereich & Status",
                          beschreibung: "Der erwartete Eisprung erscheint als Bereich (z.B. «5.–8. Jul») statt als Scheingenauigkeit – bestätigte Eisprünge zeigen ✓. Der Überblick meldet «Eisprung bestätigt» oder «Eisprung verzögert – weiter testen». Eine selbstlernende Bias-Korrektur gleicht systematische Vorhersagefehler automatisch aus."),
        WhatsNewAenderung(icon: "bell.badge.fill", farbe: .orange,
                          titel: "Smarte Mess-Erinnerungen",
                          beschreibung: "3 Tage vor dem erwarteten Eisprung erinnert dich die App an Ovulationstest und Morgentemperatur. Ist der Eisprung verzögert, kommt morgens ein Hinweis zum Weitertesten."),
        WhatsNewAenderung(icon: "pills.fill", farbe: .pink,
                          titel: "Hormonelle Verhütung berücksichtigt",
                          beschreibung: "Neuer Schalter im Zyklus-Modul: Unter hormoneller Verhütung werden Eisprung- und Fruchtbarkeits-Vorhersagen samt Erinnerungen ausgeblendet – das Perioden-Tracking bleibt aktiv."),
        WhatsNewAenderung(icon: "stethoscope", farbe: .pink,
                          titel: "Klinische Hinweise",
                          beschreibung: "Die Zyklus-Analyse erkennt Auffälligkeiten wie eine verkürzte Lutealphase, lange Zyklen oder starke Schwankungen und bereitet sie als Gesprächsgrundlage für den Frauenarzt auf – ausdrücklich keine Diagnosen."),
