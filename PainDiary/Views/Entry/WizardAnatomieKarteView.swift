...
struct WizardAnatomieKarteView: View {
    ...
    var body: some View {
        VStack(spacing: 14) {
            ...
            KoerperPickerView(auswahl: $koerperstelle, tintColor: .red, frameHeight: 420)
        }
    }
}
...
// MARK: - Reusable body picker (shared between pain wizard and skin step)
        ...
        VStack(spacing: 12) {
            ...
            if ausgewaehltSet.isEmpty {
                ...
                ScrollView(.horizontal, showsIndicators: false) {
                    HStack(spacing: 6) {
                        ForEach(ausgewaehltSet.sorted(), id: \.self) { r in
