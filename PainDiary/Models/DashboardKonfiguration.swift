...
enum KachelTyp: String, Codable, CaseIterable {
    ...
    var titel: String {
        ...
        case .schlafKachel:        return "Schlaf"
        }
    }
    ...
    var symbol: String {
        ...
        case .schlafKachel:        return "moon.stars.fill"
        }
    }
    ...
    var abschnitt: String {
        ...
        case .stimmungStress, .schnellLinks:
            return "Zuletzt"
        case .hautveraenderung, .zyklus, .schmerzKachel, .migraeneKachel, .rheumaKachel, .diabetesKachel, .wellnessKachel, .schlafKachel:
            return "Module"
